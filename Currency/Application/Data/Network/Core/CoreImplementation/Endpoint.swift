...
open class Endpoint {
    ...
    open func adding(newHTTPHeaderFields: [String: String]) -> Endpoint {
        Endpoint(url: url, sampleResponseClosure: sampleResponseClosure, method: method, task: task, encoding: encoding, httpHeaderFields: add(httpHeaderFields: newHTTPHeaderFields))
    }
    ...
    open func replacing(task: Task) -> Endpoint {
        Endpoint(url: url, sampleResponseClosure: sampleResponseClosure, method: method, task: task, encoding: encoding, httpHeaderFields: httpHeaderFields)
    }
...
public extension Endpoint {
    ...
    func urlRequest() throws -> URLRequest {
        guard let requestURL = Foundation.URL(string: url) else {
            throw NetworkLayerError.requestMapping(url)
        }
        ...
        case let .requestParametersWithTargetEncoding(parameters):
