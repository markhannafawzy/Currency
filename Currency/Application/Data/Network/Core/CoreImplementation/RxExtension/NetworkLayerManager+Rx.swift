...
extension NetworkLayerManager: ReactiveCompatible {}

public extension Reactive where Base: NetworkLayerManagerType {

    /// Designated request-making method.
    ///
    /// - Parameters:
    ///   - token: Entity, which provides specifications necessary for a `NetworkLayerManager`.
    ///   - callbackQueue: Callback queue. If nil - queue from Manager initializer will be used.
